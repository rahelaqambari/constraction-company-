    ...
    return(
        <div className=" h-fit w-full bg-stone-100 felx justify-center items-center">
            ...
            <div className="h-[90%] bg-stone-100 w-full grid grid-cols-3 grid-rows-2 justify-center items-center gap-8">
                 {filteredservices.map((cart ,index)=>(
                    ...
                    <Button  className="bg-amber-700 mt-auto mr-2 ml-auto hover:bg-amber-800  hover:cursor-pointer font-light transition-all duration-500 text-white rounded-xs ">
                     Read more...</Button>
                     <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure dignissimos voluptatibus fugiat cum fuga, nam eius voluptatem! Corporis voluptatibus aperiam consectetur in quaerat. Assumenda deserunt dolorum, accusantium maiores ex voluptates!git </p>
           Lorem ipsum dolor sit, amet consectetur adipisicing elit. Harum rerum adipisci nulla molestiae est, nostrum consequuntur quia praesentium, sed nam quaerat earum, perspiciatis ducimus vitae. Non dignissimos molestiae perspiciatis molestias.
                       </div>
                    </div>    
                    ))}
            </div>
